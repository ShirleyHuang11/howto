...
[![Recipes](https://img.shields.io/badge/recipes-156-brightgreen.svg)](INDEX.md)
...
The corpus is at **156 recipes, growing to 200**, all currently `draft` status. Where help lands hardest:
