...
Give your agent the **verified steps for 1,900+ everyday tasks** — at inference time, over the
...
- The whole corpus loads into memory once at startup (~1,900 small markdown files); no network,
  no database.
