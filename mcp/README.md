...
Give your agent the **verified steps for 2,500+ everyday tasks** — at inference time, over the
...
- The whole corpus loads into memory once at startup (~2,500 small markdown files); no network,
  no database.
